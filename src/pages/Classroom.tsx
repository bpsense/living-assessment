...
export default function ClassroomPage() {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              {isAdmin && (
                <>
                  ...
                  <button
                    onClick={() => setShowDeleteClassroom(true)}
                    className="rounded-md p-1 text-text-light transition-colors hover:bg-alert-50 hover:text-alert-600"
      ...
      {showDeleteClassroom && classroom && (
        <DeleteClassroomConfirm
          classroomId={classroom.id}
          classroomName={classroom.name}
          studentCount={activeStudents.length + archivedStudents.length}
          onClose={() => setShowDeleteClassroom(false)}
