        ...
        <div className="glass-card p-6">
          {resetSent ? (
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              ...
              <div>
                <label htmlFor="reset-email" className="mb-1 block text-sm font-medium text-text">
                  Email
                </label>
              ...
              <button
                ...
                className="w-full text-sm font-medium text-primary-500 hover:text-primary-600"
              >
                Back to sign in
              </button>
            </form>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-lg border border-bg-muted bg-bg-card px-4 py-2.5 text-sm font-medium text-text transition-colors hover:bg-bg-muted"
              >
